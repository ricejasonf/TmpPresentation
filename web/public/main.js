...
/***/ function(module, exports, __webpack_require__) {
	...
	Index = __webpack_require__(157);

	window.renderMain = function(id) {
	  return React.render(Index(), window.document.getElementById(id));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	ref = __webpack_require__(1), (ref1 = ref.addons, cloneWithProps = ref1.cloneWithProps), (ref2 = ref.DOM, ul = ref2.ul, div = ref2.div);
	...
	module.exports = ReactComponent({
	  render: function() {
	    ...
	    if (Array.isArray(this.props.children)) {
	      return ul.apply(null, [this.props].concat(slice.call((function() {
	        var j, len, ref3, results;
	        ref3 = this.props.children;
	        results = [];
	        for (i = j = 0, len = ref3.length; j < len; i = ++j) {
	          child = ref3[i];
	          results.push(div({
	            className: ['visible', !(i < this.props.step) ? 'invisible' : void 0].join(' ')
	          }, child));
	        }
	        return results;
	      }).call(this))));
	    } else {
	      return ul(this.props, this.props.children);
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	ref = __webpack_require__(158), ReactComponent = ref.ReactComponent, (ref1 = ref.DOM, div = ref1.div);
	...
	module.exports = function(options) {
	  return ReactComponent({
	    ...
	    slide: function() {
	      var slide;
	      slide = options.slides[this.frame()];
	      if (typeof slide === 'function') {
	        return slide(this.props);
	      } else {
	        return slide.element(merge(slide.props, this.props));
	      }
	    },
	    render: function() {
	      return this.slide();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(element, steps) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	ref = __webpack_require__(158), ReactComponent = ref.ReactComponent, Route = ref.Route, Link = ref.Link, (ref1 = ref.DOM, h2 = ref1.h2, div = ref1.div, ul = ref1.ul, li = ref1.li), IncrementalList = ref.IncrementalList;
	...
	module.exports = ReactComponent({
	  render: function() {
	    return div({
	      ...
	      className: 'title'
	    }, 'What is it?'), IncrementalList({
	      step: this.props.step
	    }, li(null, "Purely functional, compile-time programming language built in to Standard C++"), li(null, "Discovered accidentally as the template system just happens to be Turing-complete")));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	ref = __webpack_require__(158), ReactComponent = ref.ReactComponent, Route = ref.Route, Link = ref.Link, Syntax = ref.Syntax, (ref1 = ref.DOM, h3 = ref1.h3, div = ref1.div, ul = ref1.ul, li = ref1.li);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ref = __webpack_require__(158), ReactComponent = ref.ReactComponent, Route = ref.Route, Link = ref.Link, Syntax = ref.Syntax, (ref1 = ref.DOM, h3 = ref1.h3, div = ref1.div);
